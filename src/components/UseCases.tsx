...
export default function UseCases() {
  return (
    <section id="use-cases" className="bg-zinc-900 border-t border-zinc-800 py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {cases.map((c) => (
            <div
              key={c.title}
              className="group rounded-2xl border border-zinc-800 bg-zinc-950/60 p-7 hover:border-zinc-600 hover:bg-zinc-950 transition-all"
            >
        ...
        {/* CTA strip */}
        <div className="mt-16 rounded-2xl bg-gradient-to-r from-brand-yellow/10 to-brand-amber/5 border border-brand-yellow/20 p-8 sm:p-12 text-center">
          <h3
            className="font-display font-black uppercase text-white mb-3 leading-none"
            style={{
              fontFamily: "var(--font-barlow, 'Barlow Condensed', sans-serif)",
